    ...
    try:
        ...
        while not rospy.is_shutdown():
            ...
            if Robot.flag==1 and feature.middlepoint.x!=0 and Targe_id.transport_flag is False and enclose_flag is False and iP.P is not None:
                ...
                if object_flag==1:  
                    # if keyboard_listener.state == True:
                    ...
                    ktheta=1*max(np.linalg.norm(dx1)/np.linalg.norm(Dcosx1),np.linalg.norm(dx2)/np.linalg.norm(Dcosx2))
