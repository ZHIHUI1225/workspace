...
if __name__ == '__main__':
    try:
        ...
        for i in range(N):
            ...
            ubg.append(L*0.8)
        if Robot.flag==1:
            Target_circle=[[Robot.robotx[4]], [Robot.roboty[4]]]
            for i in range(N+1):
                g.append(ca.norm_2(X[i,:2].T-Target_circle))
                lbg.append(35* 1.5037594e-3)
                ubg.append(200)
                g.append(ca.norm_2(X[i,3:5].T-Target_circle))
                lbg.append(35** 1.5037594e-3)
                ubg.append(200) 
                for j in range(N_target):
                    g.append(ca.norm_2(X[i,6+2*j:8+2*j].T-Target_circle))
                    lbg.append(35* 1.5037594e-3)
                    ubg.append(200)
